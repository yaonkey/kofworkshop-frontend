        ...
        <div
            ...
            <div class="text-center">
                <h4 class="text-xl text-black">
                    ...
                    <span class="text-red-400 font-semibold" v-if="product.old_price !== undefined">
                        (-{{
                            parseInt(
                ...
                <div
                    ...
                    <NuxtImg class="rounded-md" loading="eager" width="256px" height="256px" :src="product.image"
                        format="avif" :placeholder="img(`/loading.svg`, { q: 10, h: 10 })" />
                </div>
                <p class="mt-2 text-lg font-medium text-gray-600 flex justify-end gap-2 flex-wrap items-end text-end">
                    <span v-if="product.old_price !== undefined" class="line-through text-red-400">
            ...
            <div class="flex mt-2 w-max md:w-full">
                <LandingLink :to="'/catalog/' + product.link || '#'" block>
